...
*  código sea lo más eficiente posible. La lectura finaliza con el código de producto igual a -1..
...
d)	Implementar un módulo que reciba la estructura generada en a), dos códigos y retorne, para cada rubro, la cantidad de productos con códigos entre los

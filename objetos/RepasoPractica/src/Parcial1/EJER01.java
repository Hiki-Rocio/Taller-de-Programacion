...
public class EJER01 {
    ...
    public static void main(String[] args) {
       Funciones f=new Funciones("Topa y muni", "20/05/23","20:00hs",4,3 );//3 filas 4 butacas
       Butacas b1 = new Butacas(1,1);
       Butacas b2 = new Butacas(2,1);
       Butacas b3 = new Butacas(3,3);
       ...
       f.OcuparButaca(1, 2);
        ...
        System.out.println("Se ocuparon alguunas butacas");
        f.DesocuparButacas(2);
        System.out.println("Se desocuparon butacas de la fila 1");
